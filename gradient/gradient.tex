...
Le vecteur gradient est orthogonal à la ligne de niveau en ce point \couleurnb{(en bleu)}{}.
...
$$ f(x,y) \ge f(x_0,y_0) \quad \text{ pour tout } (x,y) \in D.$$
  \item De même pour un \defi{maximum local} en $(x_0,y_0)$  pour lequel 
...
$} 
Voici un schéma pour retenir cette \og{}formule du sourire\fg{}\index{formule du sourire}:
