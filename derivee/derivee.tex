...
Soit $f : I \to \Rr$ une fonction, où $I$ est un intervalle ouvert (du type $]a,b[$) de $\Rr$. Soit $x_0 \in I$.
...
\begin{definition}
La \defi{dérivée seconde} en $x_0$ (si elle existe) est la dérivée de la fonction $f'$, c'est-à-dire :
$$(f')'(x_0).$$
