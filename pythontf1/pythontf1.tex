...
\begin{itemize}
  ...
  \item Pour la première couche, il faut préciser le nombre de valeurs en entrée (par l'option \ci{input_dim = ...}). Ici on a une entrée d'une seule variable. Sur la figure ci-dessous un exemple d'une entrée de dimension $3$.
